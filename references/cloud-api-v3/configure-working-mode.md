...
<iframe data-v-a6887e72="" id="frame" name="frame" src="/documentPages/htmlPages/cloud/lock/configWorkingModeEn.html" width="101%" height="1300" frameborder="0" scrolling="auto"></iframe>

## Embedded Content

# Configure Working Mode

**`https://euapi.ttlock.com/v3/lock/configWorkingMode`**
...
The modified settings can be queried using the [Get Working Mode](/document/doc?urlName=cloud/lock/getWorkingModeEn.html) API.
...
curl \--location \-g \--request POST 'https://euapi.ttlock.com/v3/lock/configWorkingMode' \\
...
2-via [gateway](https://euopen.ttlock.com/document/doc?urlName=userGuide/gatewayEn.html) or [WiFi lock](https://euopen.ttlock.com/document/doc?urlName=userGuide/wifiLockEn.html)，you can call this api with type = 2 directly if it's a WiFi lock or it's connected to gateway.  
