...
<iframe data-v-a6887e72="" id="frame" name="frame" src="/documentPages/htmlPages/cloud/lockUpgrade/checkEn.html" width="101%" height="1300" frameborder="0" scrolling="auto"></iframe>

## Embedded Content

# Upgrade check

**`https://euapi.ttlock.com/v3/lock/upgradeCheck`**

Check to see whether there is any upgrade for a lock. If there is no version info on the server, returns 'unknown'. In this case, you need to call [APP SDK](/document/doc?urlName=appSdkV3/androidSdkDemoV3/downloadEn.html) method to get `lockData`, and then request cloud API: [Upgrade recheck](/document/doc?urlName=cloud/lockUpgrade/recheckEn.html) to recheck for upgrading.
...
curl \--location \-g \--request POST 'https://euapi.ttlock.com/v3/lock/upgradeCheck' \\
